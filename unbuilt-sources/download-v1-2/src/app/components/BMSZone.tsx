      ...
      <div className="relative max-w-[1440px] mx-auto px-6 lg:px-12">
        <div className="max-w-4xl mb-14 lg:mb-20">
          <div className="flex items-center gap-3 mb-6">
            <span className="inline-flex items-center justify-center w-8 h-8 bg-[#E60023] text-white text-[11px]" style={{ fontWeight: 700 }}>05</span>
            <span className="text-[11px] tracking-[0.28em] text-white" style={{ fontWeight: 700 }}>KHU VỰC BMS & PHẦN MỀM</span>
            <div className="flex-1 h-px bg-white/20 max-w-[80px]" />
          </div>
          <h2 className="text-[40px] sm:text-[56px] lg:text-[80px] leading-[0.95] tracking-[-0.03em] mb-6" style={{ fontWeight: 700 }}>
            Trung tâm<br />
            <span className="text-[#E60023]">phần mềm BMS</span>
          </h2>
          <p className="text-[17px] leading-[1.6] text-white/75 max-w-2xl">
